...
public sealed class DeviceProfileService : IDeviceProfileService
{
    ...
    public async Task<IReadOnlyList<DeviceProfile>> LoadProfilesAsync(CancellationToken cancellationToken = default)
    {
        ...
        return profiles.Count > 0 ? profiles : [CreateFallbackCardputerZero()];
    }

    private static DeviceProfile CreateFallbackCardputerZero() => new()
    {
        Id = "cardputer-zero",
        Name = "Cardputer Zero",
        ScreenWidth = 340,
        ...
        Buttons =
        {
            new ButtonProfile { Id = "up", Label = "↑", X = 74, Y = 240, Width = 34, Height = 28, KeyCode = "Up" },
            new ButtonProfile { Id = "down", Label = "↓", X = 74, Y = 300, Width = 34, Height = 28, KeyCode = "Down" },
            new ButtonProfile { Id = "left", Label = "←", X = 36, Y = 270, Width = 34, Height = 28, KeyCode = "Left" },
            new ButtonProfile { Id = "right", Label = "→", X = 112, Y = 270, Width = 34, Height = 28, KeyCode = "Right" },
