...
public interface IAutomationService
{
    ...
    Task<EnvironmentAppStatusResult> GetEnvironmentAppStatusAsync(EnvironmentAppParams parameters);
    Task<EnvironmentOperationResult> KillEnvironmentAppAsync(EnvironmentAppParams parameters);
    Task<EnvironmentLaunchResult> LaunchEnvironmentAppAsync(EnvironmentAppParams parameters);
    Task<EnvironmentOperationResult> CleanEnvironmentAppStateAsync(EnvironmentAppParams parameters);
    Task<EnvironmentFileResult> TailEnvironmentAppLogAsync(EnvironmentAppParams parameters);
    Task<EnvironmentInputDevicesResult> GetEnvironmentInputDevicesAsync(EnvironmentCommandParams parameters);
    Task<EnvironmentEvdevCaptureResult> CaptureEnvironmentEvdevAsync(EnvironmentEvdevCaptureParams parameters);
    ...
    Task<InputActionResult> PressKeyAsync(string key);
    Task<InputActionResult> PressButtonAsync(ButtonPressParams parameters);
